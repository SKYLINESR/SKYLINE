...
io.popen("cd library && wget https://raw.githubusercontent.com/SKYLINE-DA/SKYLINE/main/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SKYLINE-DA/Files_SKYLINE/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevSKYLINEW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevSKYLINEW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevSKYLINEW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevSKYLINEW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevSKYLINEW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevSKYLINEW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevSKYLINEW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
local UserName = (data.username_ or "tttttuiopk")
...
local SKYLINE_Msg = ''  
if msgs < 100 then 
SKYLINE_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
SKYLINE_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
SKYLINE_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
SKYLINE_Msg = 'متفاعل' 
elseif msgs < 1200 then 
SKYLINE_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
SKYLINE_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
SKYLINE_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
SKYLINE_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
SKYLINE_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
SKYLINE_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
SKYLINE_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
SKYLINE_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
SKYLINE_Msg = 'رب التفاعل'  
end 
return SKYLINE_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@K_k_k_ksa")  
...
--------------------------------------------------------------------------------------------------------------
function SourceSKYLINE(msg,data) -- بداية العمل عـمرالـ دلـيـم
if msg then
...
if DevSKYLINEW(msg) then
local bl = ' *᥀︙اهلا عزيزي آلمـطـور*\n*᥀︙آنت آلمـطـور آلآسـآسـي للبوت*\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n*᥀︙تسـتطـيع‌‏ آلتحگم باوامر البوت*\n*᥀︙من خلاال الكيبورت خاص بك*\n*᥀︙قناة سورس البوت *[اضغط هنا](t.me/tttttuiopk)'
local keyboard = {
...
if start then 
SourceSKYLINEr = start
else
Namot = (database:get(bot_id..'Name:Bot') or 'ريتر')
SourceSKYLINEr = '*᥀︙اهلا عزيزي*\n*᥀︙انا بوت اسمي '..Namot..'*\n*᥀︙اختصاصي حمايه الكروبات*\n*᥀︙من تكرار والسبام والتوجيه والخ…*\n*᥀︙لتفعيلي اتبع الاخطوات…↓*\n*᥀︙اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط*\n᥀︙[قناة سورس البوت](http://t.me/tttttuiopk)'
end
send(msg.chat_id_, msg.id_, SourceSKYLINEr) 
end
end
...
local list = database:smembers(bot_id.."SKYLINE1:List:Filter"..sl)
...
if not DevSKYLINEW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevSKYLINEW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,SKYLINE_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ⋄' and DevSKYLINEW(msg) then  
...
if text == 'تعطيل التواصل ⋄' and DevSKYLINEW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⋄' and DevSKYLINEW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⋄' and DevSKYLINEW(msg) then  
...
if text == 'ضع كليشه ستارت ⋄' and DevSKYLINEW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *᥀︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ⋄' and DevSKYLINEW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *᥀︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ⋄' and DevSKYLINEW(msg) then 
...
if text == 'تحديث السورس ⋄' and DevSKYLINEW(msg) then 
os.execute('rm -rf SKYLINE.lua')
os.execute('wget https://raw.githubusercontent.com/SKYLINE-DA/SKYLINE/main/SKYLINE.lua')
send(msg.chat_id_, msg.id_,' *᥀︙تم تحديث السورس* \n*᥀︙لديك اخر اصدار لسورس ريتر*\n*᥀︙الاصدار » { 2.8v}*')
dofile('SKYLINE.lua')  
end
if text == 'الاصدار ⋄' and DevSKYLINEW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *᥀︙اصدار سورس ريتر* \n*᥀︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ⋄' and DevSKYLINEW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ᥀︙[تحديثات البوت](t.me/tttttuiopk) \n᥀︙[قناه السورس](t.me/tttttuiopk)')
end
if text == "ضع اسم للبوت ⋄" and DevSKYLINEW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *᥀︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ⋄' and DevSKYLINEW(msg) then 
...
if text == 'المشتركين ⋄' and DevSKYLINEW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *᥀︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⋄' and DevSKYLINEW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *᥀︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⋄") and DevSKYLINEW(msg) then
...
if text == ("قائمه العام ⋄") and DevSKYLINEW(msg) then
...
if text == ("قائمه الكتم العام ⋄") and DevSKYLINEW(msg) then
...
if text=="اذاعه خاص ⋄" and msg.reply_to_message_id_ == 0 and DevSKYLINEW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *᥀︙ارسل الان اذاعتك؟* \n*᥀︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ⋄" and msg.reply_to_message_id_ == 0 and DevSKYLINEW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *᥀︙ارسل الان اذاعتك؟* \n*᥀︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ⋄" and msg.reply_to_message_id_ == 0 and DevSKYLINEW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *᥀︙ارسل الان اذاعتك؟* \n*᥀︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ⋄" and msg.reply_to_message_id_ == 0  and DevSKYLINEW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *᥀︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ⋄" and msg.reply_to_message_id_ == 0  and DevSKYLINEW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ᥀︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه البوت ⋄' and DevSKYLINEW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⋄" and DevSKYLINEW(msg) then
...
if text == "تنظيف الكروبات ⋄" and DevSKYLINEW(msg) then 
...
send(msg.chat_id_, msg.id_,'*᥀︙عدد الكروبات الان » { '..#group..' }'..SKYLINEk..''..SKYLINE..'*\n*᥀︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevSKYLINEW(msg) then
...
usertext = '*\n ᥀︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'tttttuiopk')..')'
status  = '\n *᥀︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevSKYLINEW(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id..'Sudo:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *᥀︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'tttttuiopk')..')'
status  = '\n*᥀︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevSKYLINEW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevSKYLINEW(msg) then
...
local SKYLINE1_Msg = database:get(bot_id.."SKYLINE1:Add:Filter:Rp2"..text..msg.chat_id_)   
if SKYLINE1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *᥀︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'tttttuiopk')..') \n ᥀︙'..SKYLINE1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if SKYLINE_Msg and not Special(msg) then  
local SKYLINE_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if SKYLINE_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *᥀︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n᥀︙["..SKYLINE_Msg.."] \n")
else
send(msg.chat_id_,0," *᥀︙العضو :* {["..data.first_name_.."](T.ME/tttttuiopk)}\n᥀︙["..SKYLINE_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *᥀︙عذرا ↫* {["..data.first_name_.."](T.ME/tttttuiopk)}\n*᥀︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevSKYLINEW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevSKYLINEW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevSKYLINEW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *᥀︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevSKYLINEW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *᥀︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ⋄" and DevSKYLINEW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *᥀︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⋄$") and DevSKYLINEW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *᥀︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⋄" and DevSKYLINEW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ⋄" and DevSKYLINEW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *᥀︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ⋄" and DevSKYLINEW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
Text = "𝒔𝒐𝒓𝒖𝒄𝒆 𝒔𝒌𝒚𝒍𝒊𝒏𝒆\n\n[𝒔𝒌𝒚𝒍𝒊𝒏𝒆 𝒄𝒉𝒂𝒏𝒏𝒆𝒍](https://t.me/YYYDR)\n\n[𝒊𝒏𝒇𝒐 𝒔𝒐𝒓𝒖𝒄𝒆](http://t.me/tttttuiopk)\n\n[𝒔𝒌𝒚𝒍𝒊𝒏𝒆 𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓](http://t.me/K_k_k_ksa)\n\n[𝒔𝒌𝒚𝒍𝒊𝒏𝒆 𝑩𝒐𝒕](http://t.me/Vvvn66_bot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝒔𝒐𝒓𝒖𝒄𝒆 𝒔𝒌𝒚𝒍𝒊𝒏𝒆',url="t.me/tttttuiopk"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/tttttuiopk&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
if text == 'تفعيل الساوند' and Mod(msg) and GetChannelMember(msg) then  
database:del(bot_id..'sc'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,' *᥀︙تم تفعيل الساوند*') 
return false  
end
if text == 'تعطيل الساوند' and Mod(msg) and GetChannelMember(msg) then  
...
if text == 'تعطيل التيكتوك' and Mod(msg) and GetChannelMember(msg) then  
...
if text == 'رفع نسخه البوت' and DevSKYLINEW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
send(msg.chat_id_, msg.id_, '*᥀︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'tttttuiopk')..') \n*᥀︙تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *᥀︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'tttttuiopk')..') \n*᥀︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ عـمرالـدلـيـم
if text == 'تحديث' and DevSKYLINEW(msg) then
dofile('SKYLINE.lua')  
send(msg.chat_id_, msg.id_, ' *᥀︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevSKYLINEW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevSKYLINEW(msg) then  
function start_function(extra, result, success)
if SKYLINESudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevSKYLINEW(msg) then  
...
if SKYLINESudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*᥀︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevSKYLINEW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if SKYLINESudoBot(userid) then
send(msg.chat_id_, msg.id_,"*᥀︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevSKYLINEW(msg) then  
function start_function(extra, result, success)
if SKYLINESudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*᥀︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevSKYLINEW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevSKYLINEW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if SKYLINESudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*᥀︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevSKYLINEW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevSKYLINEW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevSKYLINEW(msg) then  
...
------------------------------------------------------------------------ عـمرالـدلـيـم
if text == ("مسح المطورين") and DevSKYLINEW(msg) then
...
if text == 'الملفات' and DevSKYLINEW(msg) then
t = ' *᥀︙ملفات السورس ريتر ↓*\n*— — — — — — — — — — — — — —* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if DevSKYLINEW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SKYLINE-DA/Files_SKYLINE/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *᥀︙اهلا بك في متجر ملفات ريتر*\n*᥀︙ملفات السورس ↓*\n*— — — — — — — — — — — — — —*\n\n"
local TextE = "\n*— — — — — — — — — — — — — —*\n *᥀︙علامة تعني { ✓ } ملف مفعل*\n *᥀︙علامة تعني { ✘ } ملف معطل*\n *᥀︙قناة سورس ريتر ↓*\n".." *᥀︙*[اضغط هنا لدخول](t.me/tttttuiopk) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevSKYLINEW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/SKYLINE-DA/Files_SKYLINE/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('SKYLINE.lua')  
else
send(msg.chat_id_, msg.id_," *᥀︙عذرا الملف لايدعم سورس ريتر* \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevSKYLINEW(msg) then
...
if text == "مسح الملفات" and DevSKYLINEW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *᥀︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevSKYLINEW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevSKYLINEW(msg) then  
function start_function(extra, result, success)
...
function Function_SKYLINE(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_SKYLINE, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_SKYLINE, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *᥀︙العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'tttttuiopk')..')'
status  = '\n*᥀︙تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *᥀︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'tttttuiopk')..')'
status  = '\n*᥀︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *᥀︙اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *᥀︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'tttttuiopk')..')'
...
local TEXT_SUD = database:get(bot_id..'SKYLINE:TEXT_SUDO')
if TEXT_SUDO then 
...
database:set(bot_id.."SKYLINE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."SKYLINE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *᥀︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."SKYLINE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."SKYLINE1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."SKYLINE1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."SKYLINE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *᥀︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."SKYLINE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."SKYLINE1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."SKYLINE1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."SKYLINE1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *᥀︙ارسل الكلمه الان*")  
database:set(bot_id.."SKYLINE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."SKYLINE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."SKYLINE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SKYLINE1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."SKYLINE1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."SKYLINE1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."SKYLINE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SKYLINE1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."SKYLINE1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevSKYLINEW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *᥀︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevSKYLINEW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *᥀︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'tttttuiopk')..')'..'\n*᥀︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevSKYLINEW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevSKYLINEW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ريتر').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ريتر')
local SKYLINE_Msg = {
'عمغي 🥺💕.',
...
send(msg.chat_id_, msg.id_,'['..SKYLINE_Msg[math.random(#SKYLINE_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevSKYLINEW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,SKYLINE)
local t = "\n*ツ قائمة الاعضاء* \n*— — — — — — — — — — — — — —*\n"
x = 0
local list = SKYLINE.members_
for k, v in pairs(list) do
x = x + 1
...
if SKYLINESudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevSKYLINEW(msg) then 
...
if text == ("ردود المطور") and DevSKYLINEW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ᥀︙قائمة ردود المطور \n*— — — — — — — — — — — — — —*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevSKYLINEW(msg) then    
send(msg.chat_id_, msg.id_,' *᥀︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevSKYLINEW(msg) then    
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ريتر').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevSKYLINEW(msg) then   
...
if text == 'تعطيل المغادره' and DevSKYLINEW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'tttttuiopk')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
SKYLINEdx(msg.chat_id_, msg.id_, ' *᥀︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*᥀︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*᥀︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*᥀︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevSKYLINEW(msg) then
...
{{text = '- SKYLINE TeMe .', url="t.me/tttttuiopk"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
{{text = '- SKYLINE TeMe .', url="t.me/tttttuiopk"}},
{{text = 'مطور السورس', url="t.me/K_k_k_ksa"}},
}
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'رجوع',callback_data=data.sender_user_id_.."Bbk"..OnID}},{{text = '- SKYLINE TeMe .', url="t.me/tttttuiopk"}},}
...
{{text = 'sᴏᴜʀᴄʀ ʀᴀᴛᴇʀ',url='http://t.me/tttttuiopk'}},
}
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ريتر')
...
SKYLINE = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(SKYLINE)
...
--------------------------------------------------------------------------------------------------------------
SourceSKYLINE(data.message_,data)
...
------------------------------------------------------------------------
local SKYLINEAbot = database:get(bot_id.."SKYLINE1:Add:Filter:Rp2"..text..result.chat_id_)   
if SKYLINEAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *᥀︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n᥀︙["..SKYLINEAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local SKYLINE1_Msg = database:get(bot_id.."SKYLINE1:Add:Filter:Rp2"..text..result.chat_id_)   
if SKYLINE1_Msg then
send(msg.chat_id_, msg.id_," ᥀︙"..SKYLINE1_Msg)
