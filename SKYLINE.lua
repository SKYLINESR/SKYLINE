...
Namot = (database:get(bot_id..'Name:Bot') or 'سكايلاين')
...
os.execute('wget https://raw.githubusercontent.com/SKYLINESR/SKYLINE/main/SKYLINE.lua')
send(msg.chat_id_, msg.id_,' *᥀︙تم تحديث السورس* \n*᥀︙لديك اخر اصدار لسورس سكايلاين*\n*᥀︙الاصدار » { 2.8v}*')
dofile('SKYLINE.lua')  
end
if text == 'الاصدار ᥀' and DevSKYLINEW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *᥀︙اصدار سورس سكايلاين* \n*᥀︙الاصدار »{ 2.8v}*')
end
...
usertext = '*\n ᥀︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'YYYDR')..')'
status  = '\n *᥀︙تم ترقيته مطور*'
...
usertext = '\n *᥀︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'YYYDR')..')'
status  = '\n*᥀︙تم ترقيته مطور*'
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *᥀︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'YYYDR')..') \n ᥀︙'..SKYLINE1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *᥀︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'YYYDR')..') \n*᥀︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
if Get_info then
local TextS = "\n *᥀︙اهلا بك في متجر ملفات سكايلاين*\n*᥀︙ملفات السورس ↓*\n*— — — — — — — — — — — — — —*\n\n"
...
send(msg.chat_id_, msg.id_," *᥀︙عذرا الملف لايدعم سورس سكايلاين* \n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *᥀︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'YYYDR')..')'
status  = '\n*᥀︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *᥀︙اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *᥀︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'YYYDR')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *᥀︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'YYYDR')..')'..'\n*᥀︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'سكايلاين').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'سكايلاين')
local SKYLINE_Msg = {
'عمغي 🥺💕.',
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'سكايلاين').." غادر" or text == 'غادر' then  
...
{{text = '- SKYLINE TeMe .', url="t.me/YYYDR"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'رجوع',callback_data=data.sender_user_id_.."Bbk"..OnID}},{{text = '- SKYLINE TeMe .', url="t.me/YYYDR"}},}
...
{{text = 'sᴏᴜʀᴄʀ ʀᴀᴛᴇʀ',url='http://t.me/YYYDR'}},
}
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'سكايلاين')
