...
local RunBot = io.open("SKYLINE", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/SKYLINE
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr SKYLINE.lua
wget "https://raw.githubusercontent.com/SKYLINETEAM/SKYLINE/main/SKYLINE.lua"
while(true) do
rm -fr ../.telegram-cli
./tg -s ./SKYLINE.lua -p PROFILE --bot=$token
done
]])
RunBot:close()
...
while(true) do
rm -fr ../.telegram-cli
screen -S SKYLINE -X kill
screen -S SKYLINE ./SKYLINE
done
]])
RunTs:close()
end
